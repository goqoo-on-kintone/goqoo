...
const scaffoldJs = readFilePromise('scaffold.js', 'goqoo')
const scaffoldIndexJs = readFilePromise('scaffold-index.js', 'goqoo')
const scaffoldDetailJs = readFilePromise('scaffold-detail.js', 'goqoo')
const scaffoldSubmitJs = readFilePromise('scaffold-submit.js', 'goqoo')
